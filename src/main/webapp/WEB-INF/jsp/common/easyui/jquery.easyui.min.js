...
var _a4=_a3.options;
var bb=_a3.bb={};
var _a5=$(_a2).addClass("pagination").html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"width:60%;\"><tr></tr></table>");
var tr=_a5.find("tr");
...
bb.num=$("<input class=\"pagination-num\" id=\"pageNo\" type=\"text\" value=\"1\" size=\"2\">" ).appendTo(tr).wrap("<td></td>");
...
$("<div class=\"pagination-info\" style=\"width:30%;\"></div>").appendTo(_a5);
...
},beforePageText:"第",afterPageText:"页，总共 {pages}页",displayMsg:"当前{from} 到 {to} 条，总共 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
